...
use crate::game::{snake_movement, SnakeMovement};
...
fn setup(mut commands: Commands, mut materials: ResMut<Assets<ColorMaterial>>) {
    ...
    commands.insert_resource(game::SnakeSegments::default());
}
...
fn main() {
    App::build()
        ...
        .add_system(game::snake_movement_input
            .system()
        ...
        .add_system_set(
            SystemSet::new()
                ...
                .with_system(game::snake_movement.system().label(SnakeMovement::Movement))
                .with_system(
                    game::snake_eating
                        .system()
